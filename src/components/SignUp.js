...
export default function SignUp({ setMoveBoolean }) {
    ...
    <>
      <div className="login-bg-box">
        <div className="left-login-bg">
          <div className={`spoonImg2 ${setMoveBoolean ? "moveSpoon" : ""}  `}>
            <svg
              id="_레이어_2"
              data-name="레이어 2"
          ...
          <div className={`forkImg2 ${setMoveBoolean ? "moveFork" : ""}`}>
            <svg
              id="_레이어_1"
              data-name="레이어 1"
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="signup_bg">
          <div className="container2">
            <h1 className="container_title">회원가입</h1>
            ...
            <button onClick={handleSubmit} className="loginBtn2">
              CREATE ACCOUNT
            </button>
          </div>
        </div>
